...
\textcolor{red}{Create 3 paragraphs: FedAVG w/ notation, Attack: DBA and Neurotoxin, and finally Defense: norm-based and weight ranking}
...
\textcolor{red}{Add min-mean plot compared with IQR and smoothing techniques, add algorithm pseudocode, and remove math from the footnote.}
