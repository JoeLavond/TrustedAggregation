...
\begin{figure}[H]
    ...
    \includegraphics[width=.5\textwidth]{make/99_visuals/extra_plots/min_mean--alpha10000--alpha_val10000--d_rounds30.png}
...
\paragraph{Balanced Data.} 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{cifar_10/classic/tag/centralized/alpha10000--alpha_val10000/visuals/clean_accuracy--beta0.1.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{cifar_10/classic/tag/centralized/alpha10000--alpha_val10000/visuals/pois_accuracy--beta0.1.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\textwidth]{cifar_10/classic/tag/centralized/alpha10000--alpha_val10000/visuals/threshold--d_rounds50.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}


\paragraph{Imbalanced Trusted User.}
\paragraph{Imbalanced Users.}
\paragraph{Stronger Attacks.}
