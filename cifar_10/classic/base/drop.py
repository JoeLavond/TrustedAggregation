...
def get_args():
    ...
    parser.add_argument('--drop_all', default=0, type=int)
...
def main():
    ...
    args.suffix = (
        f'--drop_p{args.drop_p}'
        + ('--drop_all' if args.drop_all else '')
    ...
    for r in range(args.n_rounds):
        ...
        pu.global_drop_(global_model, global_updates, args.drop_p, args.drop_all)
